...
class Entity[T]:
    ...
    Attributes:
        value (Optional[T]): The value of the entity, which must be hashable.
    ...
    def __init__(self,
        ...
        self._check_args(value, event, fixed_event)
        print(f"Created Entity over type {type(value)}")
    ...
    def _check_args(self, value, event, fixed_event) -> None:
        ...
        Args:
            value (Optional[T]): Value provided in initialization
